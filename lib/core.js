...
export function applyBreakthrough(baseValue, careerTier, failPenalty = 0, rng = Math.random, maxSteps = Number.POSITIVE_INFINITY) {
...
export function periodSettle(baseValue, growth = 1) {
